...
**There are three Denny's located in Alaska** 
...
**There is two La Quinta in Alaska.**
...
**The lowest is two and the highest is 6 with a mean of 4.41.**
```{r}
...
**In Alaska as the state has the lowest distance apart with a mean of 4.41 and all other states have a higher distence.**
